...
export const resume: Resume = {
  ...
  highlights: [
    ...
    },
    {
      ...
      body: "Leading the transition of multiple MGA verticals off legacy policy admin systems onto Federato, standardizing workflows, accounting, and policy lifecycle across the book.",
    },
  ],
  experience: [
    {
      ...
      summary:
        "Own the modernization of multiple MGA verticals from legacy policy admin systems onto Federato. Sit between business leadership, underwriting, actuarial, and engineering — and make the calls on how real-world workflow becomes real software.",
      bullets: [
        "Drive the transition of multiple MGA verticals off legacy policy admin platforms onto Federato, unifying them on a single database and accounting ecosystem and aligning policy status, binding, and issuance across the book.",
        ...
        "Manage four internal engineers and direct a four-person forward-deployed team from Federato, running one roadmap across two reporting lines.",
    ...
    },
    {
      ...
      bullets: [
        "Led a backend team of 2–3 engineers and kicked off the underwriting platform modernization effort that became the Federato program.",
  ...
  credentials: [
    ...
    "Society of Actuaries — Exam P (Probability)",
